  ...
  render() {
    return (
      <Fragment>
        ...
        <main className="hero-profile bg-profile bg-cover bg-center w-full h-auto flex justify-center mt-14 md:mt-28">
            ...
            <form action="">
              <div className="flex gap-8">
                <div className="w-80 h-[380px] flex flex-col justify-between items-center rounded-2xl border overflow-hidden bg-white relative">
                  <button className="btn w-8 h-8 flex justify-center items-center rounded-full bg-secondary cursor-pointer absolute top-32 right-16">
                  ...
                  <h3 className="text-sm text-greydark">
                ...
                <div className="w-full flex flex-col justify-between rounded-2xl border overflow-hidden bg-white">
                  ...
                  <div className="grid grid-cols-2 gap-9 ml-8 mr-14">
                    ...
                    <div className="input flex flex-col">
                      ...
                      <textarea name="" id="address" rows="2">
              ...
              <div className="flex gap-8 my-10">
                ...
                <div className="flex min-w-[300px] max-w-sm flex-col justify-between pb-6">
                  ...
                  <div className="flex flex-col gap-5">
                    <button className="btn h-14 rounded-2xl font-medium text-white bg-secondary flex justify-center items-center">
                      Save Change
                    </button>
                    <button className="btn h-14 rounded-2xl text-secondary font-medium bg-yellow flex justify-center items-center">
                      Cancel
                    </button>
                  </div>
                  <div className="flex flex-col gap-5">
                    <button className="btn h-14 rounded-2xl text-secondary bg-white font-medium flex justify-between  px-10  items-center">
                      Edit Password{" "}
                      <i className="bi bi-caret-right-fill text-secondary items-center font-medium"></i>
                    </button>
                    <button className="btn h-14 rounded-2xl text-secondary bg-white flex font-medium justify-between px-10 items-center">
                      Log out{" "}
